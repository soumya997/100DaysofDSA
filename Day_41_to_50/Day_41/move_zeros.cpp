...
vector<int> kadan(vector<int> arr){
    pair<int,int> p1;
    int cs = 0;
    int max_sum = INT_MIN;
    int k=0;
...
int main() {
    ...
    //     pair<int,int> k = kadan(arr);
    //     sum = arr[k.first] + arr[k.second];
    //     cout<<k.first<<"->"<<k.second<<endl;
    //     arr.erase(arr.begin()+k.first);
    //     arr.erase(arr.begin()+k.second);
    // }
    vector<int> t = kadan(arr);
    print_vec(t);
    // print_vec(arr);
